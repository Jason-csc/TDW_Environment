...
class _Screenshotter(Controller, ABC):
    ...
    def __init__(self, library: str, port=1071):
        ...
        super().__init__(port, launch_build=False, check_version=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--type", default="models_core", choices=["models_full", "models_core", "models_special","materials"],
    ...
    # Model Screenshotter.
    if args.type == "models_full" or args.type == "models_core" or args.type == "models_special":
